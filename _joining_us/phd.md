...
- Please check the course requirements for the degree program [here](https://ct.kaist.ac.kr/pages/sub/sub0402).
...
- **Funded with monthly stipend plus incentive**
    - Korean Students: Please see [here](https://ct.kaist.ac.kr/pages/sub/sub0601).
    - International Students: KAIST Scholarship provides
        - Full tuition coverage
        - National health insurance, and
        - Monthly stipend.

      Please find more info from [here](https://admission.kaist.ac.kr/intl-graduate/FinancialSupport/Scholarship/KAISTScholarship).
...
- Please send the following to the [PI's email](https://jin-woo-lee.github.io) or to `{{ site.email }}`
  1. A brief description of your research interests and why you want to join the lab.
  2. Your CV / résumé.
  3. Representative publications or a writing sample (if available).
...
- Please refer to [this link](https://ct.kaist.ac.kr/pages/sub/sub0601) for the application process and required documents for GSCT. Here are the [admission process and FAQ](https://admission.kaist.ac.kr/intl-graduate/Admission/Notice) and [scholarship info](https://admission.kaist.ac.kr/intl-graduate/FinancialSupport/Scholarship/KAISTScholarship) for international applicants.
- Quick link to the [application portal](https://gradapply.kaist.ac.kr/grad/main/schedule.do).
